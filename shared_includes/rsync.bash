...
function rsync_dir() {
	...
	time rsync --links --update --compress --recursive --itemize-changes --verbose --progress --human-readable --times --protect-args --exclude='*.o' --exclude='*.directory' --exclude='*.kra~' --exclude="node_modules/*" "$source_dir" "$dest_dir"
}
